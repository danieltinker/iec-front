                    ...
                    <v-carousel hide-delimiters :show-arrows="showArrows" class="carousel-flex" ref="pieCarousel"
                        ...
                        <v-carousel-item v-for="(KPIarr, index) in jsonData[params.selected_category]" :key="index">
                            <div class="KPIcontainer" dir="rtl">
                                <div class="kpi-box" style="padding-right:5px;padding-left:5px"
                                    v-for="(item, index) in KPIarr" :key="index" :style="{
                                    ...
                                    <span :style="{ color: getCurrentTheme.kpi.main_label }"
                                        style=" font-family: almoni-bold" class="kpi-label">
                                        {{ item.label }}
                                    </span>
                                    <br>
