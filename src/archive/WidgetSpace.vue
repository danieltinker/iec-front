...
<script lang="ts">
import BasicKPI from './BasicKPI.vue';
import ThreeDotsNineDots from '../components/utils/ThreeDotsNineDots.vue';
import BasicPie from '../components/widgets/BasicPie.vue';
        export default{
        components:{
            BasicKPI,
            ThreeDotsNineDots,
